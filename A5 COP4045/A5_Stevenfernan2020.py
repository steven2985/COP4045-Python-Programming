...
"""
Steven Fernandez Z23571583 A5 COP4045
"""
#Libraries
...
#Display message explaining what the code does for the user 
print ("In this program I will implement the functionality to read a CVS file\n"
       "containing the databaset, building a dictionary, and producing summary statisctics and plots per class\n")
